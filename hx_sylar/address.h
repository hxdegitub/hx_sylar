...
#ifndef HX_SYLAR_ADDRESS_H
#define HX_SYLAR_ADDRESS_H
#include <arpa/inet.h>
...
class IPv6Address : public IPAddress {
 public:
  ...
  auto getAddr() const -> const sockaddr* override;
  ...
  auto networdAddress(uint32_t prefix_len) -> IPAddress::ptr override;
